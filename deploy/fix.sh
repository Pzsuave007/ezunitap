...
if [ -f "$KEYS_FILE" ]; then
    ...
    for VAR in STRIPE_API_KEY STRIPE_WEBHOOK_SECRET STRIPE_CONNECT_SECRET_KEY STRIPE_CONNECT_WEBHOOK_SECRET RESEND_API_KEY OWNER_EMAIL SENDER_EMAIL SMTP_HOST SMTP_PORT SMTP_USER SMTP_PASSWORD SMTP_SECURITY; do
