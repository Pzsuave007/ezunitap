...
BASE_URL = os.environ.get("REACT_APP_BACKEND_URL", "https://invoiceflow-test.preview.emergentagent.com").rstrip("/")
...
def test_09_checkout_num_cards_2(admin_session):
    payload = {
        "plan_id": "pro_monthly",
        "origin_url": "https://invoiceflow-test.preview.emergentagent.com",
        "num_cards": 2,
    }
