...
export const TOURS = {
  ...
  card: [
    ...
    {
      target: "body",
      content: "👇 Baja un poco a la sección 'Identidad del negocio'. Ahí le dices a la AI qué tipo de negocio tienes (Roofing, Lawn Care, Cleaning, etc.). Esto entrena cómo se ve y cómo responde tu tarjeta.",
      placement: "center",
    },
    {
      target: "body",
      content: "🤖 Truco pro: en la sección 'Conocimiento de la AI' (más abajo) entrenas a tu asistente. Dile cómo cotizas, qué áreas atiendes, política de cancelación, horarios, etc. Cuando un cliente le pregunte algo en el chat de tu tarjeta, la AI le contesta con TU información — capturando el lead automáticamente.",
      placement: "center",
    },
    {
      target: "body",
      content: "🎨 También puedes cambiar el color principal de tu marca — afecta el header de tu tarjeta. Elige un color que te represente: verde, azul, rojo, lo que sea.",
      placement: "center",
    },
    {
      target: "body",
      content: "📋 Por último — en la sección 'Servicios' agregas todo lo que ofreces con precio (o 'Quote on request'). Los clientes los ven al abrir tu tarjeta. Esto te ahorra explicar lo mismo 100 veces por WhatsApp.\n\nCuando termines de configurar, ¡comparte el link y deja que la magia haga su trabajo! ✨",
      placement: "center",
    },
  ],
