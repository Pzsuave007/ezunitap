...
export const TOURS = {
  ...
  card: [
    ...
    },
    {
      ...
      content: "Acá le dices a la AI qué tipo de negocio tienes (Roofing, Lawn Care, Cleaning, etc.). Es el ingrediente principal para que tu tarjeta luzca y responda como tu industria.",
      placement: "auto",
    },
    {
      target: SELECTOR("card-ai-context"),
      content: "🤖 Truco pro: aquí entrenas a la AI de tu tarjeta. Dile cómo cotizas, áreas que atiendes, política de cancelación, etc. Cuando un cliente pregunte algo en el chat, la AI responde con TU información — y captura el lead automático.",
      placement: "auto",
    },
    {
